...
or copy the contents of <tt>src/</tt> into your main PEAR 
directory after having installed the PHP_CodeSniffer 
package from the default PEAR channel.

== Usage

  phpcs --standard=ENTB <file>
